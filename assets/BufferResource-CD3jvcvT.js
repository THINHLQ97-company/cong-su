import{$ as _,a0 as U,a1 as m}from"./minimapBase-BIV4DZVp.js";import{g,B as y,c as l}from"./Geometry-COnq5DhM.js";import{S as c,u as I}from"./main-Bir8EzqI.js";const h={name:"local-uniform-bit",vertex:{header:`
        ...
        `}},C={...h,vertex:{...h.vertex,header:h.vertex.header.replace("group(1)","group(2)")}},D={name:"local-uniform-bit",vertex:{header:`
...
`);return new Function("uv","data","dataInt32","offset",o)}function v(e,t){return`
    ...
    `}const M={f32:`
        ...
        for (let i = 0; i < 16; i++) {
            data[offset + i] = v[i];
        }`,"mat3x2<f32>":v(3,2),"mat4x2<f32>":v(4,2),"mat2x3<f32>":v(2,3),"mat4x3<f32>":v(4,3),"mat2x4<f32>":v(2,4),"mat3x4<f32>":v(3,4)},P={...M,"mat2x2<f32>":`
        data[offset] = v[0];
        data[offset + 1] = v[1];
        data[offset + 2] = v[2];
        data[offset + 3] = v[3];
    `};class L extends U{constructor({buffer:t,offset:a,size:s}){super(),this.uid=m("buffer"),this._resourceType="bufferResource",this._touched=0,this._resourceId=m("resource"),this._bufferResource=!0,this.destroyed=!1,this.buffer=t,this.offset=a|0,this.size=s,this.buffer.on("change",this.onBufferChange,this)}get _gcLastUsed(){return this.buffer?._gcLastUsed??-1}set _gcLastUsed(t){this.buffer&&(this.buffer._gcLastUsed=t)}onBufferChange(){this._resourceId=m("resource"),this.emit("change",this)}destroy(t=!1){this.destroyed=!0,t&&this.buffer.destroy(),this.emit("change",this),this.buffer=null,this.removeAllListeners()}}export{L as B,d as G,k as U,h as a,M as b,w as c,p as d,A as e,D as f,R as g,C as l,O as t,P as u};
